...
<nav id="menu" class="all">
    <div class="all_center">
        ...
        <ul class="sociais">
            <li>
                <div class="fb-like" data-href="https://www.facebook.com/palavracantada?fref=ts" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
            </li>
            ...
            <li>
                <div class="g-plusone" data-annotation="none" data-href="https://plus.google.com/+palavracantada/posts"></div>
            </li>
        </ul>
    </div>
</nav>
