<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="galeria-fotos.aspx.cs" Inherits="BrincaderiasMusicais.administracao.galeria_fotos" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Aprovar(id) {
            ...
            if (r == true) {
                ajax2 = ajaxInit();
                ajax2.open("GET", "galeria-fotos.aspx?acao=Aprovar&COF_ID=" + id + "&Rand=" + Math.ceil(Math.random() * 100000), true);
        ...
        function Reprovar(id, imagem) {
            var r = confirm("Deseja mesmo reprovar esta foto ?");
            if (r == true) {
                ajax2 = ajaxInit();
                ajax2.open("GET", "galeria-fotos.aspx?acao=Reprovar&COF_ID=" + id + "&imagem=" + imagem + "&Rand=" + Math.ceil(Math.random() * 100000), true);
                ajax2.setRequestHeader("Content-Type", "charset=iso-8859-1");
                ajax2.onreadystatechange = function () {
                    if (ajax2.readyState == 4) {
                        if (ajax2.status == 200) {
        ...
        <div class="all_center">
            <section id="conteudo">
                <h2>
                    ...
                    Galeria Colaborativa Fotos</h2>
                <!-- TABELA-->
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget red">
                            <div class="widget-title">
                                <h4>Galeria Colaborativa Fotos</h4>
