...
{
    public partial class minha_galeria : System.Web.UI.Page
    {
        private bd objBD;
        private utils objUtils;
        private OleDbDataReader rs;
        int registro = 1, pagina_atual = 1, totalPaginas = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                PopularBlog();
                breadcrumb.InnerHtml = "<a href=\"/\" title=\"Home\">Home</a> >> <a href=\"/meu-perfil/" + Session["usuUsuario"] + "\" title=\"Home\">Meu Perfil</a> >> <strong>Minhas Fotos</strong>";
            }
            catch (Exception)
            {
        ...
        private void PopularBlog()
        {
            ...
            if (rs.HasRows)
            {
                ...
                while (rs.Read())
                {
                    ...
                    divArtigos.InnerHtml += "   <p>" + rs["FOT_LEGENDA"].ToString() + "</p>";
